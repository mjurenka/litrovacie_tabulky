<?php //netteCache[01]000392a:2:{s:4:"time";s:21:"0.76012300 1395698314";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:78:"C:\xampp\htdocs\litrovacieTabulky\sandbox\app\templates\Homepage\default.latte";i:2;i:1390051631;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:22:"released on 2014-01-01";}}}?><?php

// source file: C:\xampp\htdocs\litrovacieTabulky\sandbox\app\templates\Homepage\default.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'gu0ziyjfii')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb143fcd8cc8_content')) { function _lb143fcd8cc8_content($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_l->blocks['title'][] = '_lb92d3e81a4c_title')) { function _lb92d3e81a4c_title($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_l->blocks['scripts'][] = '_lb2fc029bab5_scripts')) { function _lb2fc029bab5_scripts($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lbab38cb5f8b_head')) { function _lbab38cb5f8b_head($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
